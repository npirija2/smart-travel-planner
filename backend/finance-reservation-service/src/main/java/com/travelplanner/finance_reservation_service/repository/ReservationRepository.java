...
public interface ReservationRepository extends JpaRepository<Reservation, UUID> {
    ...
    List<Reservation> findPremiumReservations(@Param("planId") UUID planId, @Param("minPrice") Double minPrice);
    ...
    Page<Reservation> findByPlanId(UUID planId, Pageable pageable);
}